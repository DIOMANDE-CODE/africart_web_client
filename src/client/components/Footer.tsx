                ...
                <div className="footer-grid">
                    ...
                    <div className="footer-column">
                        ...
                        <ul className="footer-links">
                            <li><Link to="/products"><i className="fas fa-chevron-right" /> Tous les produits</Link></li>
                            <li><Link to="/products?tri_par=nouveautes"><i className="fas fa-chevron-right" /> Nouveautés</Link></li>
                            <li><Link to="/products?categorie=Fruits%20et%20l%C3%A9gumes"><i className="fas fa-chevron-right" /> Fruits & légumes</Link></li>
                            <li><Link to="/products?categorie=C%C3%A9r%C3%A9ales"><i className="fas fa-chevron-right" /> Céréales</Link></li>
                        </ul>
                    </div>
